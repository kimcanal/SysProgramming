...
struct bitmap* bitmap_expand(struct bitmap* bitmap, int size){
  ...
  size_t prev_size = bitmap_size(bitmap);
  struct bitmap* newBitmap = bitmap_create(prev_size + size);
  ...
  free(bitmap);
  //returns new expanded bitmap newBitmap
  return newBitmap;
}

/************* END OF new defined function   *******************/
